...
/**
 * 静态变量分类:
 *      静态外部链接: 所有函数外声明: int a=0;       | 文件作用域,静态存储周期,外部链接
 *      静态内部链接: 所有函数外声明: static int a=0;| 文件作用域,静态存储周期,内部链接
 *      静态无链接: 函数内声明: static int a=0;     | 块作用域,静态存储周期,无链接
 */
#include "stdio.h"
